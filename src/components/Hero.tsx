...
const Hero = () => {
  ...
  return (
    <section className="min-h-screen flex items-center justify-center bg-gradient-to-br from-background to-secondary text-foreground relative overflow-hidden">
      {/* Background Pattern */}
